...
button1= tk.Button(root, text="Register Here",width=25,background="white" ,fg="black",font=("Times New Roman",20),bd=0,command=reg )
button1.place(x=450,y=300)

button2= tk.Button(root, text="Capture Face",width=25,background="white" ,fg="black",font=("Times New Roman",20),bd=0,command=Create_database )
button2.place(x=450,y=500)

button2 = tk.Button(root, text="Train Face Data",width=25,command=Train_database,background="white" ,fg="black",font=("Times New Roman",20),bd=0)
button2.place(x=450, y=600)

personal = tk.Label(root, text= "Enter your Id here:",background="white" ,fg="black",font=("Times New Roman",25),bd=0)
personal.place(x=450,y=400)

button2 = tk.Button(root, text="Login Here",width=25,command=login,background="white" ,fg="black",font=("Times New Roman",20),bd=0)
button2.place(x=450, y=700)

entry2=tk.Entry(root,bd=2,width=10)
entry2.place(x=730, y=400,height=35)
